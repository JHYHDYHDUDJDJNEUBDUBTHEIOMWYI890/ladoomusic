...
OWNER_ID = int(getenv("OWNER_ID", 7343684619))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/JHYHDYHDUDJDJNEUBDUBTHEIOMWYI890/ladoomusic",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/l_apni_duniya_l")
